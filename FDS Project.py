...
# TESTING DATA df -------------------------------------------------------------------------------------
df=pd.read_csv(r"c:\Users\aaruk\Downloads\training_data.csv")
...
# TRAINING DATA tr --------------------------------------------------------------------------------
tr=pd.read_csv("c:\Users\aaruk\Downloads\test_data.csv")
...
w2 = Label(root, justify=LEFT, text="[Let's check your disease]", fg="white", bg="blue")
